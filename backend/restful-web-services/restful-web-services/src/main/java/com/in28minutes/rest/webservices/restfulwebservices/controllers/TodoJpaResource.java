...
import com.in28minutes.rest.webservices.restfulwebservices.repos.TodoJpaRepository;
...
public class TodoJpaResource {
	...
	/*
	 * @PostMapping("/users/{username}/todos") public ResponseEntity<Todo>
	 * createTodo(@PathVariable("username") String username, @RequestBody Todo todo)
